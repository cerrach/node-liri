var command = process.argv[2]; //getting liri command from command line
var subCommand = process.argv[3]; //possible sub-command for each command
var tertiaryCommand = process.argv[4]; //possible tertiary command for each command

var info = require("./keys.js"); //referencing keys.js
...
if(command === "my-tweets"){ //chain of conditionals to determine command and what to do
  getTweets(subCommand);
